...
xts_Outlier <- read_csv("../data_share/df_TS_Outlier.csv") |> 
  as.xts()
```
...
xts_Trend <- read_csv("../data_share/df_TS_TrendSeason.csv") |> as.xts()
# Remaeinder
...
xts_Bachum <- read_csv("../data_share/df_TS_Bachum.csv") |> as.xts()
xts_Villigst <- read_csv("../data_share/df_TS_Villigst.csv") |> as.xts()
```
...
```{r}
xts_Missing_T <- read_csv("../data_share/df_TS_Missing_T.csv") |> as.xts()
```
...
xts_TrendSeason <- read_csv("../data_share/df_TS_TrendSeason.csv") |> as.xts()
# Create copies for linear interpolation approach
...
xts_Bachum_Missing <- read_csv("../data_share/df_TS_Bachum_Missing.csv") |> as.xts()
xts_Villigst <- read_csv("../data_share/df_TS_Villigst.csv") |> as.xts()
